...
import { dividerDefaultColor } from '../../constants/colors'
			...
			<TouchableOpacity style={styles.wrapper}>
				<View style={styles.container}>
					<View style={styles.timeSection}>
						...
						<Text style={styles.timeTimeText}>
							{ConverDecimalHours(record?.startTime)}
						</Text>
						<Divider style={styles.timeDivider} />
						<Text style={styles.timeTimeText}>
							{ConverDecimalHours(record?.endTime)}
						</Text>
					</View>
					<View style={styles.infoSection}>
						<Text style={styles.rideType}>{record?.rideType}</Text>
						<Text>
							ФИО: <Text style={styles.boldText}>{record?.clientName}</Text>
						</Text>
						<Text>
							Количество персон:{' '}
							<Text style={styles.boldText}>{record?.personCount}</Text>
						</Text>
					</View>
				</View>
